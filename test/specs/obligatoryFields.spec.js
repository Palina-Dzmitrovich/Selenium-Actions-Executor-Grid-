...
describe('`Contact Us` obligatory fields', function() {
        ...
        it('should be hightlighted (active) if missed', async function() {
           ...
           let contactUsPage = pageFactory.getPage('contact', browser);
            ...
            browser.executeScript("document.querySelector('#_content_epam_en_about_who-we-are_contact_jcr_content_content-container_section_section-par_form_constructor_mail_subjects-label').scrollIntoView(true);");

            await contactUsPage.informationRequest.click();
